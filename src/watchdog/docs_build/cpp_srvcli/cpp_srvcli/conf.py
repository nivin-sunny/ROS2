...
exec(open("/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_srvcli/cpp_srvcli/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rosidl_default_runtime', 'rclcpp', 'example_interfaces', 'tutorial_interfaces', 'geometry_msgs']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "cpp_srvcli Doxygen Project": "/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_srvcli/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_srvcli/cpp_srvcli/default_sphinx_project/generated",
