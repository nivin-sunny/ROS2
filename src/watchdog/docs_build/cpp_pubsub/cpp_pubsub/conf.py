...
exec(open("/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_pubsub/cpp_pubsub/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rclcpp', 'std_msgs', 'tutorial_interfaces']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "cpp_pubsub Doxygen Project": "/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_pubsub/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/devuser/AOX/ros_ws/cpp_pubsub/docs_build/cpp_pubsub/cpp_pubsub/default_sphinx_project/generated",
