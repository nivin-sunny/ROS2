...
#include "tutorial_interfaces/srv/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::srv::Empty_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::Empty_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::Empty_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::Empty_Request *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Empty_Request)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tutorial_interfaces
cdr_serialize(
  const tutorial_interfaces::srv::Empty_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::Empty_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::Empty_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::Empty_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Empty_Response)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty_Response__handle;
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Empty)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Empty__handle;
}
